...
class spatial_features():
    def __init__(self, config, dataset, rieman_flag, rank_num):
        ...
        self.config = config  # Dataset specific configuration dictionary
    ...
    def embedding(self, X_train, X_test):
        ...
        train_embed = np.reshape(train_embed, (train_embed.shape[0], train_embed.shape[1] * train_embed.shape[
            2]))  # concatenate feature from different EEG bandds
